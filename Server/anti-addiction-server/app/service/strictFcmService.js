...
class StrictFcmService extends Service {
    async newFcmPolicy(game, userInfo, is_login) {
        ...
        if (userInfo.identify_state === 0) {
            return {
                remainTime: 0, costTime: 3600, restrictType: 2, title: "健康游戏提示",
        ...
        if (can_play) {
            ...
            if (needWarning !== false || is_login === 1) {
                return {
                    remainTime: can_play, costTime: costTime, restrictType: 1, title: "健康游戏提示",
            ...
            return {
                remainTime: 0, costTime: 3600, restrictType: 1, title: "健康游戏提示",
